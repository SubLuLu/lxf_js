...
![](https://cdn.liaoxuefeng.com/cdn/files/attachments/00143912121754934a42330afe74908a7d305faf0272f21000/l "run-node-hello")

在命令行模式下，可以执行`node`进入Node交互式环境，也可以执行`node hello.js`运行一个`.js`文件。

看到`>`是在Node交互式环境下：

![](https://cdn.liaoxuefeng.com/cdn/files/attachments/0014391212294193de526e6aab945c18a48203cd694f6dd000/l "node-interactive-env")
